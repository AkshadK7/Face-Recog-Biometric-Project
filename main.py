...
def contact():
    mess._show(title='Contact us',
               message="Please contact us on : 'AkshadKolhatkar@gmail.com or davesurbhit2001@gmail.com' ")
...
frame3 = tk.Frame(window, bg="#3700B3")
frame3.place(relx=0.52, rely=0.09, relwidth=0.09, relheight=0.07)

frame4 = tk.Frame(window, bg="#3700B3")
frame4.place(relx=0.36, rely=0.09, relwidth=0.16, relheight=0.07)

datef = tk.Label(frame4, text=day+"-"+mont[month]+"-"+year+"  |", fg="#ffffff",
                 bg="#262523", width=55, height=1, font=('times', 18, ' bold '))
datef.pack(fill='both', expand=1)

clock = tk.Label(frame3, fg="#FFFFFF", bg="#262523", width=55,
                 height=1, font=('times', 19, ' bold '))
clock.pack(fill='both', expand=1)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ",
                 fg="#FFFFFF", bg="#3700B3", font=('times', 17, ' bold '))
...
lbl = tk.Label(frame2, text="Enter ID", width=20, height=1,
               fg="black", bg="#ffffff", font=('times', 17, ' bold '))
lbl.place(x=80, y=55)
...
clearButton = tk.Button(frame2, text="Clear", command=clear, fg="black",
                        bg="#BB86FC", width=11, activebackground="white", font=('times', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2, fg="black",
                         bg="#BB86FC", width=11, activebackground="white", font=('times', 11, ' bold '))
clearButton2.place(x=335, y=172)
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages, fg="black", bg="#BB86FC",
                    width=34, height=1, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw, fg="black", bg="#BB86FC",
                     width=34, height=1, activebackground="white", font=('times', 15, ' bold '))
trainImg.place(x=30, y=380)
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages, fg="white",
                     bg="#6200EE", width=35, height=1, activebackground="white", font=('times', 15, ' bold '))
